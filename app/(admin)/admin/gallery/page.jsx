              ...
              {data?.data?.map((item) => (
                <div key={item._id} className="bg-surface-container border border-white/5 group relative">
                  <div className="aspect-square relative overflow-hidden bg-black/50">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                      <button
                        ...
                        className="w-10 h-10 bg-error/20 text-error hover:bg-error hover:text-black rounded-full flex items-center justify-center transition-colors"
                      >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-sm font-headline font-black text-black truncate">
                      {item.title}
                    </h3>
                  </div>
                </div>
