    ...
    <div className="relative flex flex-col items-center justify-center w-full h-full min-h-screen">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <input
                  ...
                  disabled={loading}
                  className="w-full bg-surface-container-highest border-0 border-b-2 border-transparent focus:border-primary focus:ring-0 text-on-surface p-4 transition-all duration-300 placeholder:text-on-surface-variant/70 disabled:opacity-50"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                <input
                  ...
                  disabled={loading}
                  className="w-full bg-surface-container-highest border-0 border-b-2 border-transparent focus:border-primary focus:ring-0 text-on-surface p-4 pr-12 transition-all duration-300 placeholder:text-on-surface-variant/70 disabled:opacity-50"
                  required
                />
                <button
                  type="button"
      ...
      <footer className="absolute bottom-0 w-full py-6 flex flex-col md:flex-row justify-between items-center px-8 border-t border-outline-variant/15 z-30 bg-background/80 backdrop-blur-sm">
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          <span className="text-black font-headline font-bold text-xs tracking-widest uppercase">
            BLACK BULLET GARAGE
          </span>
        </div>
