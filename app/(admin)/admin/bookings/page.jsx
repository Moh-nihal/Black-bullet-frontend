      ...
      <main className="flex-1 w-full overflow-x-hidden overflow-y-auto bg-surface min-h-screen flex flex-col">
        ...
        <header className="flex justify-between items-center w-full px-4 pl-14 md:px-8 py-4 md:py-6 sticky top-0 z-50 bg-background/60 backdrop-blur-xl border-b border-white/10">
          <div className="flex items-center gap-4 md:gap-8 h-8">
            <h2 className="font-headline text-[15px] md:text-2xl font-black tracking-widest text-black uppercase leading-none mt-1">Booking Management</h2>
          </div>
          ...
          <div className="flex-1 min-w-0 space-y-6 md:space-y-8">
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-4 mb-4">
              <div className="shrink-0">
                <h2 className="text-3xl md:text-4xl font-headline font-black tracking-tight text-black uppercase">Master Booking Log</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full xl:w-auto xl:justify-end">
                <div className="relative w-full sm:w-64 shrink-0">
                  ...
                  <input 
                    className="bg-surface-container-highest border-none text-xs font-label uppercase tracking-widest px-10 py-2 w-full focus:ring-1 focus:ring-primary placeholder:text-on-surface-variant/70 text-on-surface" 
                    ...
                    filteredBookings.map((b) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-5">
                          <span className="text-sm font-bold text-black block">{b.customerName || "N/A"}</span>
            ...
            {selectedBooking ? (
              <div className="bg-surface-container border border-white/5 p-6 space-y-8 sticky top-24">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-headline font-black uppercase tracking-widest text-black">Quick View</h3>
                ...
                <div className="relative group aspect-video overflow-hidden bg-black">
                  ...
                  <div className="absolute bottom-4 left-4">
                    ...
                    <h4 className="text-xl font-headline font-black text-black uppercase italic">{selectedBooking.vehicleMake} {selectedBooking.vehicleModel}</h4>
                  </div>
                </div>
                <div className="space-y-4 shadow-sm bg-background/20 p-4 border border-white/5">
                  ...
                  <div className="flex justify-between border-b border-white/5 pb-2">
                    ...
                    <span className="text-[10px] font-headline font-bold text-black uppercase">{selectedBooking.preferredDate ? new Date(selectedBooking.preferredDate).toLocaleDateString() : 'N/A'}</span>
                  </div>
                  <div className="flex justify-between pb-2">
                    <span className="text-[10px] font-headline font-bold text-on-surface-variant uppercase">Phone</span>
                    <span className="text-[10px] font-headline font-bold text-black uppercase">{selectedBooking.customerPhone || 'N/A'}</span>
                  </div>
                ...
                {selectedBooking.notes && (
                  <div className="pt-2">
                    ...
                    <p className="text-xs font-body text-black bg-surface-container-highest p-3 italic">"{selectedBooking.notes}"</p>
                  </div>
                )}
                {selectedBooking.message && (
                  <div className="pt-2">
                    ...
                    <p className="text-xs font-body text-black bg-surface-container-highest p-3">"{selectedBooking.message}"</p>
                  </div>
                )}
